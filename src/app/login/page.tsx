...
export default function LoginPage() {
  ...
  return (
    <main
      className="flex min-h-screen items-center justify-center bg-[#f5f5f5] px-4 py-8"
      style={{
        fontFamily:
          "-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif",
      }}
    >
      <div className="flex w-full max-w-4xl flex-col overflow-hidden border border-black bg-white md:flex-row">
        {/* Panel de imagen — mismo look del carrusel del landing, acá estática */}
        <div
          className="relative hidden min-h-[520px] flex-1 bg-cover bg-center md:block"
          ...
          <div className="relative flex h-full flex-col justify-between p-8">
            ...
            <div>
              <p className="text-2xl font-semibold leading-tight text-white">
                Outplacement de Alto Nivel
              </p>
              <p className="mt-2 text-sm text-white/70">
                Coaching personalizado para líderes ejecutivos
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full p-8 md:w-[420px] md:p-10">
          <Link
            href="/"
          ...
          <p className="mb-6 text-xs font-semibold uppercase tracking-widest text-black md:hidden">
            Executive Transition
          </p>
